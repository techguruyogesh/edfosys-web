...
export default function CrmIntegrationsEcosystem() {
  const integrations = [
    ...
    {
      name: "Razorpay & Digital Billing",
      category: "Payment & Invoicing",
      badge: "GST Compliant",
      desc: "Instant payment tracking, automated GST invoice generation, and unified billing history for subscriptions.",
      iconBg: "bg-sky-50 text-sky-600",
      tag: "Billing",
    },
    {
      name: "Webhooks & Automation Connect",
      category: "Workflow Automation",
      badge: "Event Hooks",
      desc: "Outbound event webhooks and API triggers ready to connect with Zapier, Pabbly, or custom ERP systems.",
      iconBg: "bg-orange-50 text-orange-600",
      tag: "Webhooks",
    },
    {
      name: "Amazon SES & Custom SMTP",
      category: "Transactional Email",
      badge: "SMTP & API",
      desc: "High-deliverability transactional email pipelines for quotations, invoices, and automated follow-up cadences.",
    ...
    },
    {
      ...
      badge: "Direct Sync",
      desc: "Securely store applicant documents, identity proofs, and property brochures directly in Google Drive.",
